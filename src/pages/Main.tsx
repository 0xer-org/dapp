    ...
    <Box>
      ...
      <Flex height="calc(100vh - 94px)" bg="black" mt="94px">
        <Flex m="auto" direction="column" align="center">
          ...
          <Text maxW={800} lineHeight={2} align="center">
            This is a project about seal human capabilities. In the current AI
            and robots digital generation, you and I need a trusted identity to
            prove we are unique in the world and build a network of trust
            between humans together.
          </Text>
          <Button
            mt={5}
            borderColor="white"
      ...
      <Box bg="black" p={20}>
        ...
        <Flex gap={10} mt={10} mx="auto" width={1200}>
          ...
          >
            ...
            <Text fontSize="xl">
              0xer believes that Web2 or Web3 are both important technologies
              for the Web and are different places of people's conscious
              existence. With the ERC-6551, the interactive process can be more
          ...
          >
            ...
            <Text fontSize="xl">
              Soul-bound tokens (SBTs) are data-transparent and non-tradable,
              and are used as the basis for personalized identification on the
      ...
      <Flex bg="black" p={20} direction="column" align="center">
        ...
        <Text maxW={750} align="center" my={10}>
          ...
          common time standard for the entire 0xer community. The biblical
          chapter of Genesis uses seven days to create the world, and we also
          divide an ideal 0xverse into seven chapters of development.
        </Text>
        <Flex gap={3} my={3}>
        ...
        <TabPanels flex={4} bg="#21221D" p={20} height={600}>
          <TabPanel>
            <Text my={3}>
              ...
              human being in the anonymous digital world. There are a total of
              10 levels of tests, which are currently known to be a good way to
              prove that you are human. Any methods of communication with the
              physical world, such as SMS verification, email verification,
              etc., will not be used here.
            </Text>
            <Box>
