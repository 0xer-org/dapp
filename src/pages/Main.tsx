  ...
  <Box>
    ...
    <Box bg="black" p={20}>
      ...
      <Flex gap={10} mt={10} mx="auto" width={1200}>
        <Box bg="#393A36" py={10} px={8} flex={1}>
    ...
    <Flex bg="black" p={20} direction="column" align="center">
      ...
      <Flex gap={3} my={3}>
        <Box flex={1}>
          <Image src={stage0} width="60px" />
        </Box>
        <Box flex={1}>
          <Image src={stage1} width="60px" />
        </Box>
        <Box flex={1}>
          <Image src={stage2} width="60px" />
        </Box>
        <Box flex={1}>
          <Image src={stage3} width="60px" />
        </Box>
        <Box flex={1}>
          <Image src={stage4} width="60px" />
        </Box>
        <Box flex={1}>
          <Image src={stage5} width="60px" />
        </Box>
        <Box flex={1}>
          <Image src={stage6} width="60px" />
        </Box>
      </Flex>
    </Flex>
    {/* Progress & Plan end */}
